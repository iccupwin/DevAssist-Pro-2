...
2. "timeline": Предлагаемые сроки выполнения
3. "warranty": Гарантийные обязательства
4. "work_description": Состав предлагаемых работ
5. "materials": Используемые материалы и их характеристики
6. "company_info": Квалификация персонала и опыт компании
7. "payment_terms": Условия оплаты и дополнительные условия
8. "contractor_details": Подробная информация о компании-подрядчике
