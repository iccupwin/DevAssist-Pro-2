...
import { Shield, Users, Zap, FileText, BarChart3, TrendingUp } from 'lucide-react'

export function Features() {
    return (
        <section className="bg-gray-50 py-16 md:py-32 dark:bg-transparent">
            <div className="mx-auto max-w-4xl lg:max-w-7xl px-6">
                <div className="text-center mb-12">
                    <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-4">
                        Преимущества DevAssist Pro
                    </h2>
                    <p className="text-lg text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
                        Революционная AI-платформа для автоматизации анализа коммерческих предложений в сфере недвижимости
                    </p>
                </div>
                    ...
                    <div className="relative z-10 grid grid-cols-6 gap-4">
                        <Card className="relative col-span-full flex overflow-hidden lg:col-span-2">
                            <CardContent className="relative m-auto size-fit pt-6">
                                <div className="relative flex h-24 w-56 items-center">
                                    ...
                                    <span className="mx-auto block w-fit text-5xl font-semibold text-blue-600 dark:text-blue-400">95%</span>
                                </div>
                                <h2 className="mt-6 text-center text-3xl font-semibold">Точность анализа</h2>
                            </CardContent>
                        </Card>
                        <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2">
                            <CardContent className="pt-6">
                                <div className="relative mx-auto flex aspect-square size-32 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border dark:border-white/10 dark:before:border-white/5">
                                    <Shield className="m-auto size-12 text-green-600 dark:text-green-400" strokeWidth={1} />
                                </div>
                                <div className="relative z-10 mt-6 space-y-2 text-center">
                                    <h2 className="text-lg font-medium transition dark:text-white">Безопасность данных</h2>
                                    <p className="text-foreground">Полное соблюдение требований 152-ФЗ, SOC 2 и ISO 27001. Ваши данные защищены на высшем уровне.</p>
                                </div>
                            </CardContent>
                        </Card>
                        <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2">
                                    ...
                                    <div className="relative flex h-24 w-full items-center justify-center">
                                        <div className="text-center">
                                            <div className="mx-auto flex w-fit items-center gap-2">
                                                <Zap className="size-8 text-yellow-500" strokeWidth={1.5} />
                                                <span className="text-4xl font-bold text-yellow-500">8x</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div className="relative z-10 mt-14 space-y-2 text-center">
                                    <h2 className="text-lg font-medium transition dark:text-white">Скорость анализа</h2>
                                    <p className="text-foreground">Анализ КП занимает минуты, а не часы. AI обрабатывает документы в 8 раз быстрее традиционных методов.</p>
                                </div>
                            </CardContent>
                        </Card>
                            ...
                            <CardContent className="grid pt-6 sm:grid-cols-2">
                                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                    <div className="relative flex aspect-square size-12 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border dark:border-white/10 dark:before:border-white/5">
                                        <FileText className="m-auto size-5 text-blue-600 dark:text-blue-400" strokeWidth={1} />
                                    </div>
                                    <div className="space-y-2">
                                        <h2 className="group-hover:text-secondary-950 text-lg font-medium text-zinc-800 transition dark:text-white">Умный анализ КП</h2>
                                        <p className="text-foreground">AI анализирует техническое задание и коммерческие предложения, выявляя соответствия и несоответствия.</p>
                                    </div>
                                </div>
                        ...
                        <Card className="relative col-span-full overflow-hidden lg:col-span-3">
                            <CardContent className="grid h-full pt-6 sm:grid-cols-2">
                                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                    <div className="relative flex aspect-square size-12 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border dark:border-white/10 dark:before:border-white/5">
                                        <BarChart3 className="m-auto size-6 text-purple-600 dark:text-purple-400" strokeWidth={1} />
                                    </div>
                                    <div className="space-y-2">
                                        <h2 className="text-lg font-medium transition dark:text-white">Аналитика и отчёты</h2>
                                        <p className="text-foreground">Детальная аналитика по всем КП с возможностью экспорта в PDF и Excel форматах для принятия решений.</p>
                                    </div>
                                </div>
                                <div className="before:bg-(--color-border) relative mt-6 before:absolute before:inset-0 before:mx-auto before:w-px sm:-my-6 sm:-mr-6">
                                    <div className="relative flex h-full flex-col justify-center space-y-6 py-6">
                                        <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                                            <span className="block h-fit rounded border px-2 py-1 text-xs shadow-sm">КП-1</span>
                                        ...
                                        <div className="relative ml-[calc(50%-1rem)] flex items-center gap-2">
                                            ...
                                            <span className="block h-fit rounded border px-2 py-1 text-xs shadow-sm">КП-2</span>
                                        </div>
                                        <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                                            <span className="block h-fit rounded border px-2 py-1 text-xs shadow-sm">КП-3</span>
                                            <div className="ring-background size-7 ring-4">
