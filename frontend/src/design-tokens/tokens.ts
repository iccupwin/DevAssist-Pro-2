...
export const colors = {
  ...
  semantic: {
    success: {
      ...
      500: { value: '#059669', description: 'Success color - main (WCAG AA compliant)', usage: ['success states', 'positive actions'] },
    ...
    warning: {
      ...
      500: { value: '#d97706', description: 'Warning color - main (WCAG AA compliant)', usage: ['warning states', 'caution actions'] },
    ...
    info: {
      ...
      500: { value: '#2563eb', description: 'Info color - main (WCAG AA compliant)', usage: ['info states', 'informational actions'] },
    ...
    error: {
      ...
      500: { value: '#dc2626', description: 'Error color - main (WCAG AA compliant)', usage: ['error states', 'destructive actions'] },
